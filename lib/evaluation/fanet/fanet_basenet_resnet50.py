...
face_basenet_feat_map_dim_resnet50 = {
    48: 2 ** 2 * 512,
    72: 3 ** 2 * 512,
    96: 3 ** 2 * 512,
    128: 4 ** 2 * 512,
...
class ResNet50(nn.Module):
    ...
    def __init__(self):
        ...
        self.pool5_2x2_s1 = nn.AvgPool2d(kernel_size=[2, 2], stride=[1, 1], padding=0)
    ...
    def forward(self, x):
        ...
        conv2_1 = conv2_1_1x1_proj_bn + conv2_1_1x1_increase_bn + 1
        ...
        conv2_2 = conv2_1x + conv2_2_1x1_increase_bn + 1
        ...
        conv2_3 = conv2_2x + conv2_3_1x1_increase_bn + 1
        ...
        conv3_1 = conv3_1_1x1_proj_bn + conv3_1_1x1_increase_bn + 1
        ...
        conv3_2 = conv3_1x + conv3_2_1x1_increase_bn + 1
        ...
        conv3_3 = conv3_2x + conv3_3_1x1_increase_bn + 1
        ...
        conv3_4 = conv3_3x + conv3_4_1x1_increase_bn + 1
        ...
        conv4_1 = conv4_1_1x1_proj_bn + conv4_1_1x1_increase_bn + 1
        ...
        conv4_2 = conv4_1x + conv4_2_1x1_increase_bn + 1
        ...
        conv4_3 = conv4_2x + conv4_3_1x1_increase_bn + 1
        ...
        conv4_4 = conv4_3x + conv4_4_1x1_increase_bn + 1
        ...
        conv4_5 = conv4_4x + conv4_5_1x1_increase_bn + 1
        ...
        conv4_6 = conv4_5x + conv4_6_1x1_increase_bn + 1
        ...
        conv5_1 = conv5_1_1x1_proj_bn + conv5_1_1x1_increase_bn + 1
        ...
        conv5_2 = conv5_1x + conv5_2_1x1_increase_bn + 1
        ...
        # conv5_3 = conv5_2x + conv5_3_1x1_increase_bn + 1
        # conv5_3x = self.conv5_3_relu(conv5_3)
        # pool5_2x2_s1 = self.pool5_2x2_s1(conv5_3x)

        return conv5_3_3x3_bnxx.view(conv5_3_3x3_bnxx.size(0), -1)
